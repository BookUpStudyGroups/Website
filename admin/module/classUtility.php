...
{ 
	...
	function getPaging($page, $noPage, $limitPage, $link, $linkClass)
	{
		...
		if($page > 1)
			$strReturn	.= "<li><a href=\"" . $link . "page=" . $prevPage . "\" class=\"$linkClass\">&laquo;</a></li>";
		else
			$strReturn	.= "&nbsp;&nbsp;";
		...
		{
			if($page == $startPage)
				$tmpStr	.= "<li class=\"$linkClass\"><a href='javascript:void(0);' class=\"activePage\">$startPage</a></li>";
			else
				$tmpStr	.= "<li><a href=\"" . $link . "page=" . $startPage . "\" class=\"$linkClass\">" . $startPage . "</a></li>";
		...
		{
			$nextPage 	= ($page + 1);
			$strReturn	.= "<li><a href=\"" . $link . "page=" . $nextPage . "\" class=\"$linkClass\" >&raquo;</a></li>";				
		}
		else
			$strReturn	.= "&nbsp;&nbsp;&nbsp;";
